...
TEST(ClassParser, getConstants) {
	...
	const ConstantMethodref* c3 = (ConstantMethodref*)javaClass.getConstantAt(1);
	ASSERT_EQ(22, c3->getClassIndex());
	ASSERT_EQ(51, c3->getNameAndTypeIndex());

	const ConstantInterfaceMethodref* c4 = (ConstantInterfaceMethodref*)javaClass.getConstantAt(19);
	...
	const ConstantNameAndType* c11 = (ConstantNameAndType*)javaClass.getConstantAt(51);
	...
	const ConstantMethodHandle* c13 = (ConstantMethodHandle*)javaClass.getConstantAt(59);
	ASSERT_EQ(6, c13->getReferenceKind());
	ASSERT_EQ(73, c13->getReferenceIndex());

	const ConstantMethodType* c14 = (ConstantMethodType*)javaClass.getConstantAt(62);
	ASSERT_EQ(48, c14->getDescriptorIndex());


	const ConstantInvokeDynamic* c15 = (ConstantInvokeDynamic*)javaClass.getConstantAt(13);
