...
ConstantRef::ConstantRef(const ConstantType& type, const u2& classIndex, const u2& nameAndTypeIndex)
:ConstantInfo(type),
...
:ConstantRef(ConstantType::InterfaceMethodref, classIndex, nameAndTypeIndex){
