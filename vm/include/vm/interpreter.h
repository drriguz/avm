...
namespace avm {
    ...
    public:
        ...
        virtual ~Context() {}
    public:
        inline VirtualMachine* vm() { return _jvm; }
        inline VmThread* thread() { return _thread; }
        inline Frame* frame() { return _thread->currentFrame(); }
        inline const ConstantPool* constantPool() const { return _thread->currentClass()->getRuntimeConstantPool(); }
    protected:
        VirtualMachine* _jvm;
        VmThread* _thread;
    };
